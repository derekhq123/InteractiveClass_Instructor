...
public class SystemTest2 {
    ...
    public void systemTest2() {
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.editText),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        editText.perform(replaceText("200001"), closeSoftKeyboard());
        ...
        ViewInteraction editText4 = onView(
                allOf(withId(R.id.editText2),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        editText4.perform(replaceText("password"), closeSoftKeyboard());
        ...
        ViewInteraction button2 = onView(
                allOf(withId(R.id.button1), withText("Classroom1"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.allStudentList), withText("All students list"),
                        childAtPosition(
                                childAtPosition(
